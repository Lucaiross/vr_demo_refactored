...
template<> SOCKETIOCLIENT_NON_ATTRIBUTED_API UEnum* StaticEnum<ESIOConnectionCloseReason>()
{
...
template<> SOCKETIOCLIENT_NON_ATTRIBUTED_API UEnum* StaticEnum<ESIOThreadOverrideOption>()
{
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_vr_demo_refactored_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h__Script_SocketIOClient_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ESIOConnectionCloseReason_StaticEnum, TEXT("ESIOConnectionCloseReason"), &Z_Registration_Info_UEnum_ESIOConnectionCloseReason, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2685082294U) },
		{ ESIOThreadOverrideOption_StaticEnum, TEXT("ESIOThreadOverrideOption"), &Z_Registration_Info_UEnum_ESIOThreadOverrideOption, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 568530726U) },
	};
}; // Z_CompiledInDeferFile_FID_vr_demo_refactored_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h__Script_SocketIOClient_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_vr_demo_refactored_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h__Script_SocketIOClient_1571602718{
	TEXT("/Script/SocketIOClient"),
	nullptr, 0,
	nullptr, 0,
	Z_CompiledInDeferFile_FID_vr_demo_refactored_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h__Script_SocketIOClient_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_vr_demo_refactored_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h__Script_SocketIOClient_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
