...
template<> SIOJSON_NON_ATTRIBUTED_API UEnum* StaticEnum<ESIORequestVerb>()
{
...
template<> SIOJSON_NON_ATTRIBUTED_API UEnum* StaticEnum<ESIORequestContentType>()
{
...
template<> SIOJSON_NON_ATTRIBUTED_API UEnum* StaticEnum<ESIORequestStatus>()
{
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_vr_demo_refactored_Plugins_SocketIOClient_Source_SIOJson_Public_SIOJTypes_h__Script_SIOJson_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ESIORequestVerb_StaticEnum, TEXT("ESIORequestVerb"), &Z_Registration_Info_UEnum_ESIORequestVerb, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 795667494U) },
		{ ESIORequestContentType_StaticEnum, TEXT("ESIORequestContentType"), &Z_Registration_Info_UEnum_ESIORequestContentType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3626241558U) },
		{ ESIORequestStatus_StaticEnum, TEXT("ESIORequestStatus"), &Z_Registration_Info_UEnum_ESIORequestStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2431702031U) },
	};
}; // Z_CompiledInDeferFile_FID_vr_demo_refactored_Plugins_SocketIOClient_Source_SIOJson_Public_SIOJTypes_h__Script_SIOJson_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_vr_demo_refactored_Plugins_SocketIOClient_Source_SIOJson_Public_SIOJTypes_h__Script_SIOJson_2409263743{
	TEXT("/Script/SIOJson"),
	nullptr, 0,
	nullptr, 0,
	Z_CompiledInDeferFile_FID_vr_demo_refactored_Plugins_SocketIOClient_Source_SIOJson_Public_SIOJTypes_h__Script_SIOJson_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_vr_demo_refactored_Plugins_SocketIOClient_Source_SIOJson_Public_SIOJTypes_h__Script_SIOJson_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
